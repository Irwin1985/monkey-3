...
// TokenLiteral returns call expression token literal.
...
// TokenLiteral returns array token literal.
...
// IndexExpression is an index expression.
...
// TokenLiteral returns index token literal.
