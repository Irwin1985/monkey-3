...
func New(l *lexer.Lexer) *Parser {
	...
	p.registerInfix(token.LBRACKET, p.parseIndexExpressin)
...
// ParseProgram parses program from lexer and builds an AST.
...
func (p *Parser) parseIndexExpressin(left ast.Expression) ast.Expression {
